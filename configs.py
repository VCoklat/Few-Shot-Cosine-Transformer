...
data_dir['miniImagenet']    = '/kaggle/working/Few-Shot-Cosine-Transformer/dataset/miniImagenet/' 
data_dir['Omniglot']        = '/kaggle/working/Few-Shot-Cosine-Transformer/dataset/Omniglot/' 
