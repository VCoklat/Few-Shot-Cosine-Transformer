...
echo "1. Ensure you have the required checkpoint files"
echo "2. Copy the command and paste it in your terminal"
echo "3. Adjust paths as needed for your setup"
echo "4. Results will be saved to the specified output path"
echo ""
