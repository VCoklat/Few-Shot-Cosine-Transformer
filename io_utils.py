...
def parse_args():
    ...
    parser.add_argument('--cov_weight', type=float, default=0.4, help='Initial covariance weight')
    parser.add_argument('--var_weight', type=float, default=0.2, help='Initial variance weight')
    parser.add_argument('--dynamic_weight', type=lambda x: (str(x).lower() == 'true'), default=True,
                   help='Whether to use dynamic weighting (true/false)')
