...
# ================================================================================================
# YOUR THREE REQUESTED FUNCTIONS - INTEGRATED HERE
# ================================================================================================
...
# ================================================================================================
# ADDITIONAL FUNCTIONS THAT USE YOUR THREE FUNCTIONS
# ================================================================================================
...
def evaluate_model_comprehensive(test_loader, model, params, testfile):
    """Comprehensive model evaluation using YOUR THREE FUNCTIONS"""
    print("\n🔍 Starting comprehensive model evaluation...")

    # Use YOUR get_class_names_from_file function
    ...
    # Use YOUR get_system_metrics function
    ...
    # Use YOUR get_system_metrics function again
...
def direct_test(test_loader, model, params):
    """Enhanced direct test with memory optimization"""
    acc = []
...
def analyze_dynamic_weights(model, val_loader):
    ...
    with torch.no_grad():
        model.eval()
        with tqdm.tqdm(total=min(50, len(val_loader)), desc="Collecting weights") as pbar:
            for i, (x, _) in enumerate(val_loader):
                if i >= 50:  # Limit to 50 batches for efficiency
                    break
...
if __name__ == '__main__':
    ...
    # Analyze dynamic weights if using cosine variant with dynamic weighting
    ...
    # Traditional test results for compatibility
    ...
    with open('./record/results.txt', 'a') as f:
        ...
        f.write('Time: %s   Setting: %s %s | Macro-F1: %.4f | Inf-Time: %.1fms | Params: %.2fM\n' % 
               (timestamp, exp_setting.ljust(50), acc_str, eval_results['macro_f1'], 
                eval_results['avg_inf_time']*1000, eval_results['param_count']))
